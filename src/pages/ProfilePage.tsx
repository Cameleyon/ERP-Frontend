...
export default function ProfilePage() {
  ...
  const text = language === "fr"
    ? {
        ...
        locationsCreateSuccess: "Site cree avec succes",
        locationsCreateError: "Echec de la creation du site",
        locationsLoadError: "Echec du chargement des sites",
        assignedLocations: "Sites assignes",
