...
export default function ProfilePage() {
  ...
  const text = language === "fr"
    ? {
        ...
        locationsSectionTitle: "Succursales",
        locationsSectionSubtitle: "Ajoutez les succursales ou sites geres par cette entreprise.",
        locationName: "Nom de la succursale",
        addLocationTitle: "Ajouter une succursale",
        addLocationButton: "Ajouter la succursale",
        locationsCreateSuccess: "Succursale creee avec succes",
        locationsCreateError: "Echec de la creation de la succursale",
        locationsLoadError: "Echec du chargement des succursales",
        assignedLocations: "Succursales assignees",
    ...
    : {
        ...
        locationsSectionTitle: "Branches",
        locationsSectionSubtitle: "Add the branches or sites managed by this company.",
        locationName: "Branch name",
        addLocationTitle: "Add a branch",
        addLocationButton: "Add branch",
        locationsCreateSuccess: "Branch created successfully",
        locationsCreateError: "Failed to create branch",
        locationsLoadError: "Failed to load branches",
        assignedLocations: "Assigned branches",
