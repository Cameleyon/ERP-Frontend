...
export default function ProfilePage() {
  ...
  const text = language === "fr"
    ? {
        ...
        userProfileSuccess: "Profil utilisateur mis à jour avec succès",
        userProfileError: "Échec de la mise à jour du profil utilisateur",
        emailPasswordRequired: "Le mot de passe actuel est requis pour changer l'e-mail",
        companyInfo: "Informations de l'entreprise",
        usersSectionTitle: "Utilisateurs",
        usersSectionSubtitle: "Ajoutez ou retirez des utilisateurs supplémentaires. Tout mois entamé reste dû, et la prochaine facturation reflétera les changements de statut.",
        usersLoadError: "Échec du chargement des utilisateurs",
        usersCreateError: "Échec de la création de l'utilisateur",
        usersCreateSuccess: "Utilisateur créé avec succès",
        usersUpdateStatusError: "Échec de la mise à jour du statut de l'utilisateur",
        usersUpdateStatusSuccess: "Statut de l'utilisateur mis à jour avec succès",
        additionalUserWarningTitle: "Impact tarifaire",
        additionalUserWarningMessage: "Chaque utilisateur supplémentaire actif ajoute 5 USD au prochain cycle de facturation. Si un utilisateur est désactivé, le changement sera pris en compte à la prochaine facturation.",
        additionalUserConsentLabel: "Je comprends et j'accepte l'augmentation de 5 USD pour cet utilisateur supplémentaire.",
        additionalUserConsentRequired: "Votre consentement est requis avant de créer un utilisateur supplémentaire.",
        usersRequired: "Tous les champs de création d'utilisateur sont requis",
        usersListTitle: "Utilisateurs de l'entreprise",
        locationsSectionTitle: "Sites",
        locationsSectionSubtitle: "Ajoutez les sites gérés par cette entreprise.",
        ...
        additionalLocationConsentRequired: "Votre consentement est requis avant de créer un nouveau site.",
        locationName: "Nom du site",
        addLocationTitle: "Ajouter un site",
        addLocationButton: "Ajouter le site",
        locationsCreateSuccess: "Site créé avec succès",
        locationsCreateError: "Échec de la création du site",
        locationsLoadError: "Échec du chargement des sites",
        assignedLocations: "Sites assignés",
        ...
        additionalUserFee: "Frais par utilisateur supplémentaire",
        additionalUserTotal: "Supplément total par cycle",
        additionalLocations: "Sites supplémentaires",
        additionalLocationFee: "Frais par site supplémentaire",
        additionalLocationTotal: "Supplément sites par cycle",
        notes: "Notes",
        yes: "Oui",
        no: "Non",
    ...
    : {
        ...
        locationsCreateSuccess: "Site created successfully",
        locationsCreateError: "Failed to create site",
        locationsLoadError: "Failed to load sites",
        assignedLocations: "Assigned sites",
