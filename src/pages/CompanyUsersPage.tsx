...
export default function CompanyUsersPage() {
  ...
  const text = language === "fr"
    ? {
        ...
        warningMessage:
          "Chaque utilisateur supplémentaire créé par un admin augmente les frais de 5 USD. Veuillez confirmer votre consentement avant de continuer.",
        consentLabel:
          "Je comprends et j'accepte l'augmentation de 5 USD pour cet utilisateur supplémentaire.",
        consentRequired:
          "Votre consentement est requis avant de créer un utilisateur supplémentaire.",
